...
def get_tommorow(message):
    try:
        ...
        bot.send_message(message.chat.id, 'Не понимаю тебя, проверь правильность группы (Например, /tommorow A1234)', parse_mode='HTML')
    ...
    if not day_number == "0":
        ...
        for day in days:
            ...
            try:
                ...
                resp += "<b>Некорректный запрос. Попробуй еще</b>\n\n"
        bot.send_message(message.chat.id, resp, parse_mode='HTML')
