...
@bot.message_handler(commands=['tommorow']) #f
...
def get_all_schedule(message):
    ...
    try:
        ...
        bot.send_message(message.chat.id, 'Не понимаю тебя, проверь правильность группы (Например, /all A1234)', parse_mode='HTML')
